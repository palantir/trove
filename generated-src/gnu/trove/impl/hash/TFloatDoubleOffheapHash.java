 ...
 */
abstract public class TFloatDoubleOffheapHash extends TPrimitiveOffheapHash {
	static final long serialVersionUID = 1L;

    /** the set of floats */
    public transient TFloatOffheapArray _set;
     ...
     */
    public TFloatDoubleOffheapHash() {
     ...
     * capacity and load factor.
     */
    public TFloatDoubleOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TFloatDoubleOffheapHash</code> instance with a prime
     ...
     */
    public TFloatDoubleOffheapHash( int initialCapacity, float loadFactor ) {
        super( initialCapacity, loadFactor );
        _set = new TFloatOffheapArray( capacity() );
