 ...
 */
abstract public class TLongLongOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TLongLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TLongLongOffheapHash</code> instance with a prime
     ...
     */
    public TLongLongOffheapHash( int initialCapacity, float loadFactor ) {
