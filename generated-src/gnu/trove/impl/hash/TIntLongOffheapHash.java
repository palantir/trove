 ...
 */
abstract public class TIntLongOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TIntLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TIntLongOffheapHash</code> instance with a prime
     ...
     */
    public TIntLongOffheapHash( int initialCapacity, float loadFactor ) {
