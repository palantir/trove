 ...
 */
abstract public class TDoubleIntOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TDoubleIntOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TDoubleIntOffheapHash</code> instance with a prime
     ...
     */
    public TDoubleIntOffheapHash( int initialCapacity, float loadFactor ) {
