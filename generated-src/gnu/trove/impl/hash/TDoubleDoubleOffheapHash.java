 ...
 */
abstract public class TDoubleDoubleOffheapHash extends TPrimitiveOffheapHash {
	static final long serialVersionUID = 1L;

    /** the set of doubles */
    public transient TDoubleOffheapArray _set;
     ...
     */
    public TDoubleDoubleOffheapHash() {
     ...
     * capacity and load factor.
     */
    public TDoubleDoubleOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TDoubleDoubleOffheapHash</code> instance with a prime
     ...
     */
    public TDoubleDoubleOffheapHash( int initialCapacity, float loadFactor ) {
        super( initialCapacity, loadFactor );
        _set = new TDoubleOffheapArray( capacity() );
