 ...
 */
abstract public class TLongByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TLongByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TLongByteOffheapHash</code> instance with a prime
     ...
     */
    public TLongByteOffheapHash( int initialCapacity, float loadFactor ) {
