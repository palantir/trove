 ...
 */
abstract public class TLongShortOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TLongShortOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TLongShortOffheapHash</code> instance with a prime
     ...
     */
    public TLongShortOffheapHash( int initialCapacity, float loadFactor ) {
