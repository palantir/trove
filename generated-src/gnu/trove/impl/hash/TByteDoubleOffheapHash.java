 ...
 */
abstract public class TByteDoubleOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TByteDoubleOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TByteDoubleOffheapHash</code> instance with a prime
     ...
     */
    public TByteDoubleOffheapHash( int initialCapacity, float loadFactor ) {
