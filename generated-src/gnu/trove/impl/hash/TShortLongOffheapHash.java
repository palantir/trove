 ...
 */
abstract public class TShortLongOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TShortLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TShortLongOffheapHash</code> instance with a prime
     ...
     */
    public TShortLongOffheapHash( int initialCapacity, float loadFactor ) {
