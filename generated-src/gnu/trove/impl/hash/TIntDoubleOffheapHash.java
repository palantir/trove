 ...
 */
abstract public class TIntDoubleOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TIntDoubleOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TIntDoubleOffheapHash</code> instance with a prime
     ...
     */
    public TIntDoubleOffheapHash( int initialCapacity, float loadFactor ) {
