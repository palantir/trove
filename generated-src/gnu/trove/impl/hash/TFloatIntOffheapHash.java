 ...
 */
abstract public class TFloatIntOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TFloatIntOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TFloatIntOffheapHash</code> instance with a prime
     ...
     */
    public TFloatIntOffheapHash( int initialCapacity, float loadFactor ) {
