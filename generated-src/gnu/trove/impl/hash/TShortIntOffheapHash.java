 ...
 */
abstract public class TShortIntOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TShortIntOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TShortIntOffheapHash</code> instance with a prime
     ...
     */
    public TShortIntOffheapHash( int initialCapacity, float loadFactor ) {
