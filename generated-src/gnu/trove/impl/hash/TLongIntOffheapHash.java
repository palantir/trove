 ...
 */
abstract public class TLongIntOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TLongIntOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TLongIntOffheapHash</code> instance with a prime
     ...
     */
    public TLongIntOffheapHash( int initialCapacity, float loadFactor ) {
