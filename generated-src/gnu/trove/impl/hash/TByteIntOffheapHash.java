 ...
 */
abstract public class TByteIntOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TByteIntOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TByteIntOffheapHash</code> instance with a prime
     ...
     */
    public TByteIntOffheapHash( int initialCapacity, float loadFactor ) {
