 ...
 */
abstract public class TCharLongOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TCharLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharLongOffheapHash</code> instance with a prime
     ...
     */
    public TCharLongOffheapHash( int initialCapacity, float loadFactor ) {
