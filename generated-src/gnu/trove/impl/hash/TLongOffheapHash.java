 ...
 */
abstract public class TLongOffheapHash extends TPrimitiveOffheapHash {
	static final long serialVersionUID = 1L;

    /** the set of longs */
    public transient TLongOffheapArray _set;
     ...
     * capacity and load factor.
     */
    public TLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TLongOffheapHash</code> instance whose capacity
     * is the next highest prime above <tt>initialCapacity + 1</tt>
     * unless that value is already prime.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TLongOffheapHash( int initialCapacity, float load_factor ) {
        super( initialCapacity, load_factor );
        _set = new TLongOffheapArray( capacity() );
    }
    ...
    public long getNoEntryValue() {
        return Constants.DEFAULT_LONG_NO_ENTRY_VALUE;
    }
