 ...
 */
abstract public class TShortDoubleOffheapHash extends TPrimitiveOffheapHash {
	static final long serialVersionUID = 1L;

    /** the set of shorts */
    public transient TShortOffheapArray _set;
     ...
     */
    public TShortDoubleOffheapHash() {
     ...
     * capacity and load factor.
     */
    public TShortDoubleOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TShortDoubleOffheapHash</code> instance with a prime
     ...
     */
    public TShortDoubleOffheapHash( int initialCapacity, float loadFactor ) {
        super( initialCapacity, loadFactor );
        _set = new TShortOffheapArray( capacity() );
