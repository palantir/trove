 ...
 */
abstract public class TByteCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TByteCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TByteCharOffheapHash</code> instance with a prime
     ...
     */
    public TByteCharOffheapHash( int initialCapacity, float loadFactor ) {
