 ...
 */
abstract public class TLongFloatOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TLongFloatOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TLongFloatOffheapHash</code> instance with a prime
     ...
     */
    public TLongFloatOffheapHash( int initialCapacity, float loadFactor ) {
