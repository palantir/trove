 ...
 */
abstract public class TCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharOffheapHash</code> instance whose capacity
     * is the next highest prime above <tt>initialCapacity + 1</tt>
     * unless that value is already prime.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TCharOffheapHash( int initialCapacity, float load_factor ) {
