 ...
 */
abstract public class TShortShortOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TShortShortOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TShortShortOffheapHash</code> instance with a prime
     ...
     */
    public TShortShortOffheapHash( int initialCapacity, float loadFactor ) {
