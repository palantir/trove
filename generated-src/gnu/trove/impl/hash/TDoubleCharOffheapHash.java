 ...
 */
abstract public class TDoubleCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TDoubleCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TDoubleCharOffheapHash</code> instance with a prime
     ...
     */
    public TDoubleCharOffheapHash( int initialCapacity, float loadFactor ) {
