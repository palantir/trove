 ...
 */
abstract public class TCharIntOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TCharIntOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharIntOffheapHash</code> instance with a prime
     ...
     */
    public TCharIntOffheapHash( int initialCapacity, float loadFactor ) {
