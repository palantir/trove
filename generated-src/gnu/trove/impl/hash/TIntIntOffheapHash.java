 ...
 */
abstract public class TIntIntOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TIntIntOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TIntIntOffheapHash</code> instance with a prime
     ...
     */
    public TIntIntOffheapHash( int initialCapacity, float loadFactor ) {
