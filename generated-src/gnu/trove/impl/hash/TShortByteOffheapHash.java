 ...
 */
abstract public class TShortByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TShortByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TShortByteOffheapHash</code> instance with a prime
     ...
     */
    public TShortByteOffheapHash( int initialCapacity, float loadFactor ) {
