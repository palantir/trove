 ...
 */
abstract public class TShortFloatOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TShortFloatOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TShortFloatOffheapHash</code> instance with a prime
     ...
     */
    public TShortFloatOffheapHash( int initialCapacity, float loadFactor ) {
