 ...
 */
abstract public class TFloatByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TFloatByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TFloatByteOffheapHash</code> instance with a prime
     ...
     */
    public TFloatByteOffheapHash( int initialCapacity, float loadFactor ) {
