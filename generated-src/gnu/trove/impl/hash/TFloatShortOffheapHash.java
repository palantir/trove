 ...
 */
abstract public class TFloatShortOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TFloatShortOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TFloatShortOffheapHash</code> instance with a prime
     ...
     */
    public TFloatShortOffheapHash( int initialCapacity, float loadFactor ) {
