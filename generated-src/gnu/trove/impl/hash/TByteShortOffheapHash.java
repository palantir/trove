 ...
 */
abstract public class TByteShortOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TByteShortOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TByteShortOffheapHash</code> instance with a prime
     ...
     */
    public TByteShortOffheapHash( int initialCapacity, float loadFactor ) {
