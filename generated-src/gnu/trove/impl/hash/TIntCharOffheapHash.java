 ...
 */
abstract public class TIntCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TIntCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TIntCharOffheapHash</code> instance with a prime
     ...
     */
    public TIntCharOffheapHash( int initialCapacity, float loadFactor ) {
