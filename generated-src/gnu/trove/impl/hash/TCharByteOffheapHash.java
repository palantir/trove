 ...
 */
abstract public class TCharByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TCharByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharByteOffheapHash</code> instance with a prime
     ...
     */
    public TCharByteOffheapHash( int initialCapacity, float loadFactor ) {
