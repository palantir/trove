 ...
 */
abstract public class TCharShortOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TCharShortOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharShortOffheapHash</code> instance with a prime
     ...
     */
    public TCharShortOffheapHash( int initialCapacity, float loadFactor ) {
