 ...
 */
abstract public class TDoubleShortOffheapHash extends TPrimitiveOffheapHash {
     ...
     */
    public TDoubleShortOffheapHash() {
     ...
     * capacity and load factor.
     */
    public TDoubleShortOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TDoubleShortOffheapHash</code> instance with a prime
     ...
     */
    public TDoubleShortOffheapHash( int initialCapacity, float loadFactor ) {
