 ...
 */
abstract public class TDoubleFloatOffheapHash extends TPrimitiveOffheapHash {
     ...
     */
    public TDoubleFloatOffheapHash() {
     ...
     * capacity and load factor.
     */
    public TDoubleFloatOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TDoubleFloatOffheapHash</code> instance with a prime
     ...
     */
    public TDoubleFloatOffheapHash( int initialCapacity, float loadFactor ) {
