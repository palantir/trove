 ...
 */
abstract public class TFloatCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TFloatCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TFloatCharOffheapHash</code> instance with a prime
     ...
     */
    public TFloatCharOffheapHash( int initialCapacity, float loadFactor ) {
