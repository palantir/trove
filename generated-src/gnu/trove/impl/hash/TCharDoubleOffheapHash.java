 ...
 */
abstract public class TCharDoubleOffheapHash extends TPrimitiveOffheapHash {
	static final long serialVersionUID = 1L;

    /** the set of chars */
    public transient TCharOffheapArray _set;
     ...
     * capacity and load factor.
     */
    public TCharDoubleOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharDoubleOffheapHash</code> instance with a prime
     ...
     */
    public TCharDoubleOffheapHash( int initialCapacity, float loadFactor ) {
        super( initialCapacity, loadFactor );
        _set = new TCharOffheapArray( capacity() );
        no_entry_key = ( char ) 0;
