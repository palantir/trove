 ...
 */
abstract public class TIntShortOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TIntShortOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TIntShortOffheapHash</code> instance with a prime
     ...
     */
    public TIntShortOffheapHash( int initialCapacity, float loadFactor ) {
