 ...
 */
abstract public class TShortCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TShortCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TShortCharOffheapHash</code> instance with a prime
     ...
     */
    public TShortCharOffheapHash( int initialCapacity, float loadFactor ) {
