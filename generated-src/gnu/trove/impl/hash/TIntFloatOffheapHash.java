 ...
 */
abstract public class TIntFloatOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TIntFloatOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TIntFloatOffheapHash</code> instance with a prime
     ...
     */
    public TIntFloatOffheapHash( int initialCapacity, float loadFactor ) {
