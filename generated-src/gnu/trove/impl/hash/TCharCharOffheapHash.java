 ...
 */
abstract public class TCharCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TCharCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharCharOffheapHash</code> instance with a prime
     ...
     */
    public TCharCharOffheapHash( int initialCapacity, float loadFactor ) {
