 ...
 */
abstract public class TByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TByteOffheapHash</code> instance whose capacity
     * is the next highest prime above <tt>initialCapacity + 1</tt>
     * unless that value is already prime.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TByteOffheapHash( int initialCapacity, float load_factor ) {
    ...
    public byte getNoEntryValue() {
        return Constants.DEFAULT_BYTE_NO_ENTRY_VALUE;
    }
