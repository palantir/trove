 ...
 */
abstract public class TDoubleLongOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TDoubleLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TDoubleLongOffheapHash</code> instance with a prime
     ...
     */
    public TDoubleLongOffheapHash( int initialCapacity, float loadFactor ) {
