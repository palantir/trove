 ...
 */
abstract public class TFloatFloatOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TFloatFloatOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TFloatFloatOffheapHash</code> instance with a prime
     ...
     */
    public TFloatFloatOffheapHash( int initialCapacity, float loadFactor ) {
