 ...
 */
abstract public class TDoubleByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TDoubleByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TDoubleByteOffheapHash</code> instance with a prime
     ...
     */
    public TDoubleByteOffheapHash( int initialCapacity, float loadFactor ) {
