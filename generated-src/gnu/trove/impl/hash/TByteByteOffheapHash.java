 ...
 */
abstract public class TByteByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TByteByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TByteByteOffheapHash</code> instance with a prime
     ...
     */
    public TByteByteOffheapHash( int initialCapacity, float loadFactor ) {
