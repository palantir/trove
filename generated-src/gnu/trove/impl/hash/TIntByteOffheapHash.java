 ...
 */
abstract public class TIntByteOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TIntByteOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TIntByteOffheapHash</code> instance with a prime
     ...
     */
    public TIntByteOffheapHash( int initialCapacity, float loadFactor ) {
