 ...
 */
abstract public class TFloatLongOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TFloatLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TFloatLongOffheapHash</code> instance with a prime
     ...
     */
    public TFloatLongOffheapHash( int initialCapacity, float loadFactor ) {
