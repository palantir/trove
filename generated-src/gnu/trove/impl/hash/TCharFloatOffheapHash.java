 ...
 */
abstract public class TCharFloatOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TCharFloatOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TCharFloatOffheapHash</code> instance with a prime
     ...
     */
    public TCharFloatOffheapHash( int initialCapacity, float loadFactor ) {
