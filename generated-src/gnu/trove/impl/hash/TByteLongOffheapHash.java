 ...
 */
abstract public class TByteLongOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TByteLongOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TByteLongOffheapHash</code> instance with a prime
     ...
     */
    public TByteLongOffheapHash( int initialCapacity, float loadFactor ) {
