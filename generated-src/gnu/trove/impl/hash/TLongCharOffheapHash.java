 ...
 */
abstract public class TLongCharOffheapHash extends TPrimitiveOffheapHash {
     ...
     * capacity and load factor.
     */
    public TLongCharOffheapHash( int capacity ) {
        this( capacity, DEFAULT_LOAD_FACTOR );
    }


    /**
     * Creates a new <code>TLongCharOffheapHash</code> instance with a prime
     ...
     */
    public TLongCharOffheapHash( int initialCapacity, float loadFactor ) {
