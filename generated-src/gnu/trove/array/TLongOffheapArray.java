 ...
 */
public class TLongOffheapArray extends AbstractOffheapArray {
    ...
    public void put(long index, long value) {
        check(index);
        UNSAFE.putLong(address + (index << SHIFT), value);
    }

    public long get(long index) {
        check(index);
        return UNSAFE.getLong(address + (index << SHIFT));
    }
    ...
    public String toString() {
        ...
        for (long i = 0; i < capacity(); i++) {
            ...
            s.append(UNSAFE.getLong(address + (i << SHIFT)));
        }
        s.append("]");
        return s.toString();
    }
    ...
    static {
        TLongOffheapArray array = new TLongOffheapArray(10);
        assert(array.capacity() == 10);
        array.put(3, (long) -45);
        array.put(5, (long) 121);
        ...
        staticAssert(array.get(3) == -45);
        staticAssert(array.get(4) == 0);
        array.fromArray(new long[] {(long) -3, 0, 4, 5}, 0, 7, 4);
        staticAssert(array.get(6) == 0);
        ...
        staticAssert(Arrays.equals(dst, new long[] {(long) -45, 0, 0, 0, (long) -3}));
        array.clear();
        array.toArray(3, dst, 0, 5);
        staticAssert(Arrays.equals(dst, new long[] {0, 0, 0, 0, 0}));
        array.free();
    }
