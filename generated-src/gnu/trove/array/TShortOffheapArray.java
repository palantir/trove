 ...
 */
public class TShortOffheapArray extends AbstractOffheapArray {
    private static final int SHIFT = 31 - Integer.numberOfLeadingZeros(2);
    private static final long ARRAY_OFFSET = UNSAFE.arrayBaseOffset(short[].class);
    private static final int ARRAY_SHIFT = 31 - Integer.numberOfLeadingZeros(UNSAFE.arrayIndexScale(short[].class));
    private static final long UNSAFE_COPY_THRESHOLD = 1024L * 1024L;

    public TShortOffheapArray(long capacity) {
    ...
    public void put(long index, short value) {
        check(index);
        UNSAFE.putShort(address + (index << SHIFT), value);
    }

    public short get(long index) {
        check(index);
        return UNSAFE.getShort(address + (index << SHIFT));
    }

    public void toArray(long srcIndex, short[] dst, int dstIndex, int length) {
    ...
    public void fromArray(short[] src, int srcIndex, long dstIndex, int length) {
    ...
    public String toString() {
        ...
        for (long i = 0; i < capacity(); i++) {
            ...
            s.append(UNSAFE.getShort(address + (i << SHIFT)));
        }
        s.append("]");
        return s.toString();
    }
    ...
    static {
        TShortOffheapArray array = new TShortOffheapArray(10);
        assert(array.capacity() == 10);
        array.put(3, (short) -45);
        array.put(5, (short) 121);
        ...
        staticAssert(array.get(3) == -45);
        staticAssert(array.get(4) == 0);
        array.fromArray(new short[] {(short) -3, 0, 4, 5}, 0, 7, 4);
        staticAssert(array.get(6) == 0);
        ...
        staticAssert(Arrays.equals(dst, new short[] {(short) -45, 0, 0, 0, (short) -3}));
        array.clear();
        array.toArray(3, dst, 0, 5);
        staticAssert(Arrays.equals(dst, new short[] {0, 0, 0, 0, 0}));
        array.free();
    }
