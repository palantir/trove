 ...
 */
public class TCharOffheapArrayList implements TCharList, Externalizable {
    ...
    /**
     * Creates a new <code>TCharOffheapArrayList</code> instance with the
     * default capacity.
     */
    ...
    public TCharOffheapArrayList( int capacity, char no_entry_value ) {
        _data = new TCharOffheapArray( capacity );
        _pos = 0;
    ...
    public char set( int offset, char val ) {
        ...
        char prev_val = _data.get( offset );
    ...
    public boolean equals( Object other ) {
        ...
        else if ( other instanceof TCharOffheapArrayList ) {
    ...
    class TCharOffheapArrayIterator implements TCharIterator {
    ...
    public void readExternal( ObjectInput in )
        ...
        // ENTRIES
        int len = in.readInt();
        _data = new TCharOffheapArray( len );
        for( int i = 0; i < len; i++ ) {
            _data.put( i, in.readChar() );
        }
    }
} // TCharArrayList
