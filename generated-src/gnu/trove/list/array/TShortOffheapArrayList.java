 ...
 */
public class TShortOffheapArrayList implements TShortList, Externalizable {
    static final long serialVersionUID = 1L;

    /** the data of the list */
    protected TShortOffheapArray _data;
    ...
    /**
     * Creates a new <code>TShortOffheapArrayList</code> instance with the
     * default capacity.
     */
    public TShortOffheapArrayList() {
     ...
     * default capacity.
     */
    public TShortOffheapArrayList( int capacity ) {
     ...
     */
    public TShortOffheapArrayList( int capacity, short no_entry_value ) {
        _data = new TShortOffheapArray( capacity );
        _pos = 0;
    ...
    public TShortIterator iterator() {
        return new TShortOffheapArrayIterator( 0 );
    }
    ...
    public boolean equals( Object other ) {
        ...
        else if ( other instanceof TShortOffheapArrayList ) {
            TShortOffheapArrayList that = ( TShortOffheapArrayList )other;
    ...
    class TShortOffheapArrayIterator implements TShortIterator {
        ...
        TShortOffheapArrayIterator( int index ) {
            cursor = index;
        }
