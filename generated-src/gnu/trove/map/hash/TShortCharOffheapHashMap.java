 ...
 */
public class TShortCharOffheapHashMap extends TShortCharOffheapHash implements TShortCharMap, Externalizable {
    ...
    /**
     * Creates a new <code>TShortCharOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TShortCharOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TShortCharOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TShortCharOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TShortCharOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TShortCharIterator iterator() {
        return new TShortCharOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TShortSet {
        ...
        public TShortIterator iterator() {
            return new TShortCharKeyOffheapHashIterator( TShortCharOffheapHashMap.this );
        }
        ...
        public boolean contains( short entry ) {
            return TShortCharOffheapHashMap.this.contains( entry );
        }
        ...
        public short[] toArray() {
            return TShortCharOffheapHashMap.this.keys();
        }
        ...
        public short[] toArray( short[] dest ) {
            return TShortCharOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( short entry ) {
            return no_entry_value != TShortCharOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Short ) {
                    ...
                    if ( ! TShortCharOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TShortCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TShortCharOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( short[] array ) {
            for ( short element : array ) {
                if ( ! TShortCharOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TShortCharOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TShortProcedure procedure ) {
            return TShortCharOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TCharCollection {
        ...
        public TCharIterator iterator() {
            return new TShortCharValueOffheapHashIterator( TShortCharOffheapHashMap.this );
        }
        ...
        public boolean contains( char entry ) {
            return TShortCharOffheapHashMap.this.containsValue( entry );
        }
        ...
        @Override
        public char[] toArray() {
            return TShortCharOffheapHashMap.this.values();
        }
        ...
        public char[] toArray( char[] dest ) {
            return TShortCharOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Character ) {
                    ...
                    if ( ! TShortCharOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TCharCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TShortCharOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( char[] array ) {
            for ( char element : array ) {
                if ( ! TShortCharOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TCharProcedure procedure ) {
            return TShortCharOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TShortCharKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TShortIterator {
         ...
         */
        TShortCharKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TShortCharOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TShortCharValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TCharIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TShortCharValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TShortCharOffheapHashIterator extends THashPrimitiveOffheapIterator implements TShortCharIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TShortCharOffheapHashMap</tt> we will be iterating over.
         */
        TShortCharOffheapHashIterator( TShortCharOffheapHashMap map ) {
            super( map );
        }
