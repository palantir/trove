 ...
 */
public class TIntFloatOffheapHashMap extends TIntFloatOffheapHash implements TIntFloatMap, Externalizable {
    ...
    /**
     * Creates a new <code>TIntFloatOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TIntFloatOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TIntFloatOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TIntFloatOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TIntFloatOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TIntFloatIterator iterator() {
        return new TIntFloatOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TIntSet {
        ...
        public TIntIterator iterator() {
            return new TIntFloatKeyOffheapHashIterator( TIntFloatOffheapHashMap.this );
        }
        ...
        public boolean contains( int entry ) {
            return TIntFloatOffheapHashMap.this.contains( entry );
        }
        ...
        @Override
        public int[] toArray() {
            return TIntFloatOffheapHashMap.this.keys();
        }
        ...
        public int[] toArray( int[] dest ) {
            return TIntFloatOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( int entry ) {
            return no_entry_value != TIntFloatOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Integer ) {
                    ...
                    if ( ! TIntFloatOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TIntCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TIntFloatOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( int[] array ) {
            for ( int element : array ) {
                if ( ! TIntFloatOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TIntFloatOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TIntProcedure procedure ) {
            return TIntFloatOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TFloatCollection {
        ...
        public TFloatIterator iterator() {
            return new TIntFloatValueOffheapHashIterator( TIntFloatOffheapHashMap.this );
        }
        ...
        public boolean contains( float entry ) {
            return TIntFloatOffheapHashMap.this.containsValue( entry );
        }
        ...
        public float[] toArray() {
            return TIntFloatOffheapHashMap.this.values();
        }
        ...
        public float[] toArray( float[] dest ) {
            return TIntFloatOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Float ) {
                    ...
                    if ( ! TIntFloatOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TFloatCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TIntFloatOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( float[] array ) {
            for ( float element : array ) {
                if ( ! TIntFloatOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TFloatProcedure procedure ) {
            return TIntFloatOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TIntFloatKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TIntIterator {
         ...
         */
        TIntFloatKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TIntFloatOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TIntFloatValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TFloatIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TIntFloatValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TIntFloatOffheapHashIterator extends THashPrimitiveOffheapIterator implements TIntFloatIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TIntFloatOffheapHashMap</tt> we will be iterating over.
         */
        TIntFloatOffheapHashIterator( TIntFloatOffheapHashMap map ) {
            super( map );
        }
