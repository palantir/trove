 ...
 */
public class TShortIntOffheapHashMap extends TShortIntOffheapHash implements TShortIntMap, Externalizable {
    ...
    /**
     * Creates a new <code>TShortIntOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TShortIntOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TShortIntOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TShortIntOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TShortIntOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TShortIntIterator iterator() {
        return new TShortIntOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TShortSet {
        ...
        public TShortIterator iterator() {
            return new TShortIntKeyOffheapHashIterator( TShortIntOffheapHashMap.this );
        }
        ...
        public boolean contains( short entry ) {
            return TShortIntOffheapHashMap.this.contains( entry );
        }
        ...
        public short[] toArray() {
            return TShortIntOffheapHashMap.this.keys();
        }
        ...
        public short[] toArray( short[] dest ) {
            return TShortIntOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( short entry ) {
            return no_entry_value != TShortIntOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Short ) {
                    ...
                    if ( ! TShortIntOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TShortCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TShortIntOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( short[] array ) {
            for ( short element : array ) {
                if ( ! TShortIntOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TShortIntOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TShortProcedure procedure ) {
            return TShortIntOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TIntCollection {
        ...
        public TIntIterator iterator() {
            return new TShortIntValueOffheapHashIterator( TShortIntOffheapHashMap.this );
        }
        ...
        public boolean contains( int entry ) {
            return TShortIntOffheapHashMap.this.containsValue( entry );
        }
        ...
        @Override
        public int[] toArray() {
            return TShortIntOffheapHashMap.this.values();
        }
        ...
        public int[] toArray( int[] dest ) {
            return TShortIntOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Integer ) {
                    ...
                    if ( ! TShortIntOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TIntCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TShortIntOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( int[] array ) {
            for ( int element : array ) {
                if ( ! TShortIntOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TIntProcedure procedure ) {
            return TShortIntOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TShortIntKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TShortIterator {
         ...
         */
        TShortIntKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TShortIntOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TShortIntValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TIntIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TShortIntValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TShortIntOffheapHashIterator extends THashPrimitiveOffheapIterator implements TShortIntIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TShortIntOffheapHashMap</tt> we will be iterating over.
         */
        TShortIntOffheapHashIterator( TShortIntOffheapHashMap map ) {
            super( map );
        }
