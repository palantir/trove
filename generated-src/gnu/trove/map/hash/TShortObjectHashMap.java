...
public class TShortObjectHashMap<V> extends TShortHash implements
    ...
    protected class ValueView extends MapBackedView<V> {
        ...
        class TShortObjectValueHashIterator extends THashPrimitiveIterator
            ...
            protected final TShortObjectHashMap<V> _map;

            public TShortObjectValueHashIterator( TShortObjectHashMap<V> map ) {
                super( map );
                _map = map;
            }
    ...
    class TShortObjectHashIterator extends THashPrimitiveIterator
