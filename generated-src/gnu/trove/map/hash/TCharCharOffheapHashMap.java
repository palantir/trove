 ...
 */
public class TCharCharOffheapHashMap extends TCharCharOffheapHash implements TCharCharMap, Externalizable {
    ...
    /**
     * Creates a new <code>TCharCharOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TCharCharOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TCharCharOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TCharCharOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TCharCharOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TCharCharIterator iterator() {
        return new TCharCharOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TCharSet {
        ...
        public TCharIterator iterator() {
            return new TCharCharKeyOffheapHashIterator( TCharCharOffheapHashMap.this );
        }
        ...
        public boolean contains( char entry ) {
            return TCharCharOffheapHashMap.this.contains( entry );
        }
        ...
        @Override
        public char[] toArray() {
            return TCharCharOffheapHashMap.this.keys();
        }
        ...
        public char[] toArray( char[] dest ) {
            return TCharCharOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( char entry ) {
            return no_entry_value != TCharCharOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Character ) {
                    ...
                    if ( ! TCharCharOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( char[] array ) {
            for ( char element : array ) {
                if ( ! TCharCharOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TCharCharOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TCharProcedure procedure ) {
            return TCharCharOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TCharCollection {
        ...
        @Override
        public TCharIterator iterator() {
            return new TCharCharValueOffheapHashIterator( TCharCharOffheapHashMap.this );
        }
        ...
        @Override
        public boolean contains( char entry ) {
            return TCharCharOffheapHashMap.this.containsValue( entry );
        }
        ...
        @Override
        public char[] toArray() {
            return TCharCharOffheapHashMap.this.values();
        }
        ...
        @Override
        public char[] toArray( char[] dest ) {
            return TCharCharOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Character ) {
                    char ele = ( ( Character ) element ).charValue();
                    if ( ! TCharCharOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TCharCollection collection ) {
            TCharIterator iter = collection.iterator();
            while ( iter.hasNext() ) {
                if ( ! TCharCharOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( char[] array ) {
            for ( char element : array ) {
                if ( ! TCharCharOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public boolean forEach( TCharProcedure procedure ) {
            return TCharCharOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TCharCharKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TCharIterator {
         ...
         */
        TCharCharKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TCharCharOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TCharCharValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TCharIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TCharCharValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TCharCharOffheapHashIterator extends THashPrimitiveOffheapIterator implements TCharCharIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TCharCharOffheapHashMap</tt> we will be iterating over.
         */
        TCharCharOffheapHashIterator( TCharCharOffheapHashMap map ) {
            super( map );
        }
