 ...
 */
public class TFloatDoubleOffheapHashMap extends TFloatDoubleOffheapHash implements TFloatDoubleMap, Externalizable {
    ...
    /**
     * Creates a new <code>TFloatDoubleOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TFloatDoubleOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TFloatDoubleOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TFloatDoubleOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TFloatDoubleOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TFloatDoubleIterator iterator() {
        return new TFloatDoubleOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TFloatSet {
        ...
        public TFloatIterator iterator() {
            return new TFloatDoubleKeyOffheapHashIterator( TFloatDoubleOffheapHashMap.this );
        }
        ...
        public boolean contains( float entry ) {
            return TFloatDoubleOffheapHashMap.this.contains( entry );
        }
        ...
        public float[] toArray() {
            return TFloatDoubleOffheapHashMap.this.keys();
        }
        ...
        public float[] toArray( float[] dest ) {
            return TFloatDoubleOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( float entry ) {
            return no_entry_value != TFloatDoubleOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Float ) {
                    ...
                    if ( ! TFloatDoubleOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TFloatCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TFloatDoubleOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( float[] array ) {
            for ( float element : array ) {
                if ( ! TFloatDoubleOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TFloatDoubleOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TFloatProcedure procedure ) {
            return TFloatDoubleOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TDoubleCollection {
        ...
        public TDoubleIterator iterator() {
            return new TFloatDoubleValueOffheapHashIterator( TFloatDoubleOffheapHashMap.this );
        }
        ...
        public boolean contains( double entry ) {
            return TFloatDoubleOffheapHashMap.this.containsValue( entry );
        }
        ...
        public double[] toArray() {
            return TFloatDoubleOffheapHashMap.this.values();
        }
        ...
        public double[] toArray( double[] dest ) {
            return TFloatDoubleOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Double ) {
                    ...
                    if ( ! TFloatDoubleOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TDoubleCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TFloatDoubleOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( double[] array ) {
            for ( double element : array ) {
                if ( ! TFloatDoubleOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TDoubleProcedure procedure ) {
            return TFloatDoubleOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TFloatDoubleKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TFloatIterator {
         ...
         */
        TFloatDoubleKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TFloatDoubleOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TFloatDoubleValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TDoubleIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TFloatDoubleValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TFloatDoubleOffheapHashIterator extends THashPrimitiveOffheapIterator implements TFloatDoubleIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TFloatDoubleOffheapHashMap</tt> we will be iterating over.
         */
        TFloatDoubleOffheapHashIterator( TFloatDoubleOffheapHashMap map ) {
            super( map );
        }
