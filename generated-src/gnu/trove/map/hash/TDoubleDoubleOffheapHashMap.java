 ...
 */
public class TDoubleDoubleOffheapHashMap extends TDoubleDoubleOffheapHash implements TDoubleDoubleMap, Externalizable {
    ...
    /**
     * Creates a new <code>TDoubleDoubleOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TDoubleDoubleOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TDoubleDoubleOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TDoubleDoubleOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TDoubleDoubleOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TDoubleDoubleIterator iterator() {
        return new TDoubleDoubleOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TDoubleSet {
        ...
        public TDoubleIterator iterator() {
            return new TDoubleDoubleKeyOffheapHashIterator( TDoubleDoubleOffheapHashMap.this );
        }
        ...
        public boolean contains( double entry ) {
            return TDoubleDoubleOffheapHashMap.this.contains( entry );
        }
        ...
        public double[] toArray() {
            return TDoubleDoubleOffheapHashMap.this.keys();
        }
        ...
        public double[] toArray( double[] dest ) {
            return TDoubleDoubleOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( double entry ) {
            return no_entry_value != TDoubleDoubleOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Double ) {
                    ...
                    if ( ! TDoubleDoubleOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TDoubleCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TDoubleDoubleOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( double[] array ) {
            for ( double element : array ) {
                if ( ! TDoubleDoubleOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TDoubleDoubleOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TDoubleProcedure procedure ) {
            return TDoubleDoubleOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TDoubleCollection {
        ...
        @Override
        public TDoubleIterator iterator() {
            return new TDoubleDoubleValueOffheapHashIterator( TDoubleDoubleOffheapHashMap.this );
        }
        ...
        @Override
        public boolean contains( double entry ) {
            return TDoubleDoubleOffheapHashMap.this.containsValue( entry );
        }
        ...
        @Override
        public double[] toArray() {
            return TDoubleDoubleOffheapHashMap.this.values();
        }
        ...
        @Override
        public double[] toArray( double[] dest ) {
            return TDoubleDoubleOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Double ) {
                    double ele = ( ( Double ) element ).doubleValue();
                    if ( ! TDoubleDoubleOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TDoubleCollection collection ) {
            TDoubleIterator iter = collection.iterator();
            while ( iter.hasNext() ) {
                if ( ! TDoubleDoubleOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( double[] array ) {
            for ( double element : array ) {
                if ( ! TDoubleDoubleOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public boolean forEach( TDoubleProcedure procedure ) {
            return TDoubleDoubleOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TDoubleDoubleKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TDoubleIterator {
         ...
         */
        TDoubleDoubleKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TDoubleDoubleOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TDoubleDoubleValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TDoubleIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TDoubleDoubleValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TDoubleDoubleOffheapHashIterator extends THashPrimitiveOffheapIterator implements TDoubleDoubleIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TDoubleDoubleOffheapHashMap</tt> we will be iterating over.
         */
        TDoubleDoubleOffheapHashIterator( TDoubleDoubleOffheapHashMap map ) {
            super( map );
        }
