 ...
 */
public class TCharByteOffheapHashMap extends TCharByteOffheapHash implements TCharByteMap, Externalizable {
    ...
    /**
     * Creates a new <code>TCharByteOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TCharByteOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TCharByteOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TCharByteOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TCharByteOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TCharByteIterator iterator() {
        return new TCharByteOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TCharSet {
        ...
        public TCharIterator iterator() {
            return new TCharByteKeyOffheapHashIterator( TCharByteOffheapHashMap.this );
        }
        ...
        public boolean contains( char entry ) {
            return TCharByteOffheapHashMap.this.contains( entry );
        }
        ...
        @Override
        public char[] toArray() {
            return TCharByteOffheapHashMap.this.keys();
        }
        ...
        public char[] toArray( char[] dest ) {
            return TCharByteOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( char entry ) {
            return no_entry_value != TCharByteOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Character ) {
                    ...
                    if ( ! TCharByteOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TCharCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TCharByteOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( char[] array ) {
            for ( char element : array ) {
                if ( ! TCharByteOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TCharByteOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TCharProcedure procedure ) {
            return TCharByteOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TByteCollection {
        ...
        public TByteIterator iterator() {
            return new TCharByteValueOffheapHashIterator( TCharByteOffheapHashMap.this );
        }
        ...
        public boolean contains( byte entry ) {
            return TCharByteOffheapHashMap.this.containsValue( entry );
        }
        ...
        @Override
        public byte[] toArray() {
            return TCharByteOffheapHashMap.this.values();
        }
        ...
        public byte[] toArray( byte[] dest ) {
            return TCharByteOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Byte ) {
                    ...
                    if ( ! TCharByteOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TByteCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TCharByteOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( byte[] array ) {
            for ( byte element : array ) {
                if ( ! TCharByteOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TByteProcedure procedure ) {
            return TCharByteOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TCharByteKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TCharIterator {
         ...
         */
        TCharByteKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TCharByteOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TCharByteValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TCharByteValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TCharByteOffheapHashIterator extends THashPrimitiveOffheapIterator implements TCharByteIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TCharByteOffheapHashMap</tt> we will be iterating over.
         */
        TCharByteOffheapHashIterator( TCharByteOffheapHashMap map ) {
            super( map );
        }
