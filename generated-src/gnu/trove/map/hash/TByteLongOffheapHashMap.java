 ...
 */
public class TByteLongOffheapHashMap extends TByteLongOffheapHash implements TByteLongMap, Externalizable {
    ...
    /**
     * Creates a new <code>TByteLongOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TByteLongOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TByteLongOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TByteLongOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TByteLongOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TByteLongIterator iterator() {
        return new TByteLongOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TByteSet {
        ...
        public TByteIterator iterator() {
            return new TByteLongKeyOffheapHashIterator( TByteLongOffheapHashMap.this );
        }
        ...
        public boolean contains( byte entry ) {
            return TByteLongOffheapHashMap.this.contains( entry );
        }
        ...
        @Override
        public byte[] toArray() {
            return TByteLongOffheapHashMap.this.keys();
        }
        ...
        public byte[] toArray( byte[] dest ) {
            return TByteLongOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( byte entry ) {
            return no_entry_value != TByteLongOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Byte ) {
                    ...
                    if ( ! TByteLongOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TByteCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteLongOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( byte[] array ) {
            for ( byte element : array ) {
                if ( ! TByteLongOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TByteLongOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TByteProcedure procedure ) {
            return TByteLongOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TLongCollection {
        ...
        public TLongIterator iterator() {
            return new TByteLongValueOffheapHashIterator( TByteLongOffheapHashMap.this );
        }
        ...
        public boolean contains( long entry ) {
            return TByteLongOffheapHashMap.this.containsValue( entry );
        }
        ...
        @Override
        public long[] toArray() {
            return TByteLongOffheapHashMap.this.values();
        }
        ...
        public long[] toArray( long[] dest ) {
            return TByteLongOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Long ) {
                    ...
                    if ( ! TByteLongOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TLongCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteLongOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( long[] array ) {
            for ( long element : array ) {
                if ( ! TByteLongOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TLongProcedure procedure ) {
            return TByteLongOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TByteLongKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteIterator {
         ...
         */
        TByteLongKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TByteLongOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TByteLongValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TLongIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TByteLongValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TByteLongOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteLongIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TByteLongOffheapHashMap</tt> we will be iterating over.
         */
        TByteLongOffheapHashIterator( TByteLongOffheapHashMap map ) {
            super( map );
        }
