 ...
 */
public class TByteIntOffheapHashMap extends TByteIntOffheapHash implements TByteIntMap, Externalizable {
    ...
    /**
     * Creates a new <code>TByteIntOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TByteIntOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TByteIntOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TByteIntOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TByteIntOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TByteIntIterator iterator() {
        return new TByteIntOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TByteSet {
        ...
        public TByteIterator iterator() {
            return new TByteIntKeyOffheapHashIterator( TByteIntOffheapHashMap.this );
        }
        ...
        public boolean contains( byte entry ) {
            return TByteIntOffheapHashMap.this.contains( entry );
        }
        ...
        @Override
        public byte[] toArray() {
            return TByteIntOffheapHashMap.this.keys();
        }
        ...
        public byte[] toArray( byte[] dest ) {
            return TByteIntOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( byte entry ) {
            return no_entry_value != TByteIntOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Byte ) {
                    ...
                    if ( ! TByteIntOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TByteCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteIntOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( byte[] array ) {
            for ( byte element : array ) {
                if ( ! TByteIntOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TByteIntOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TByteProcedure procedure ) {
            return TByteIntOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TIntCollection {
        ...
        public TIntIterator iterator() {
            return new TByteIntValueOffheapHashIterator( TByteIntOffheapHashMap.this );
        }
        ...
        public boolean contains( int entry ) {
            return TByteIntOffheapHashMap.this.containsValue( entry );
        }
        ...
        @Override
        public int[] toArray() {
            return TByteIntOffheapHashMap.this.values();
        }
        ...
        public int[] toArray( int[] dest ) {
            return TByteIntOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Integer ) {
                    ...
                    if ( ! TByteIntOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TIntCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteIntOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( int[] array ) {
            for ( int element : array ) {
                if ( ! TByteIntOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TIntProcedure procedure ) {
            return TByteIntOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TByteIntKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteIterator {
         ...
         */
        TByteIntKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TByteIntOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TByteIntValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TIntIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TByteIntValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TByteIntOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteIntIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TByteIntOffheapHashMap</tt> we will be iterating over.
         */
        TByteIntOffheapHashIterator( TByteIntOffheapHashMap map ) {
            super( map );
        }
