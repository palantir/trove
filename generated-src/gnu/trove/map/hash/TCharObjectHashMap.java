...
public class TCharObjectHashMap<V> extends TCharHash implements
    ...
    protected class ValueView extends MapBackedView<V> {
        ...
        class TCharObjectValueHashIterator extends THashPrimitiveIterator
            ...
            protected final TCharObjectHashMap<V> _map;

            public TCharObjectValueHashIterator( TCharObjectHashMap<V> map ) {
                super( map );
                _map = map;
            }
    ...
    class TCharObjectHashIterator extends THashPrimitiveIterator
