 ...
 */
public class TByteFloatOffheapHashMap extends TByteFloatOffheapHash implements TByteFloatMap, Externalizable {
    ...
    /**
     * Creates a new <code>TByteFloatOffheapHashMap</code> instance with the default
     * capacity and load factor.
     */
    public TByteFloatOffheapHashMap() {
        this( DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR );
    }

    
    /**
     * Creates a new <code>TByteFloatOffheapHashMap</code> instance with a prime
     * capacity equal to or greater than <tt>initialCapacity</tt> and
     * with the default load factor.
     *
     * @param initialCapacity an <code>int</code> value
     */
    public TByteFloatOffheapHashMap( int initialCapacity ) {
     ...
     */
    public TByteFloatOffheapHashMap( int initialCapacity, float loadFactor ) {
    ...
    public TByteFloatIterator iterator() {
        return new TByteFloatOffheapHashIterator( this );
    }
    ...
    protected class TKeyView implements TByteSet {
        ...
        public TByteIterator iterator() {
            return new TByteFloatKeyOffheapHashIterator( TByteFloatOffheapHashMap.this );
        }
        ...
        public boolean contains( byte entry ) {
            return TByteFloatOffheapHashMap.this.contains( entry );
        }
        ...
        @Override
        public byte[] toArray() {
            return TByteFloatOffheapHashMap.this.keys();
        }
        ...
        public byte[] toArray( byte[] dest ) {
            return TByteFloatOffheapHashMap.this.keys( dest );
        }
        ...
        public boolean remove( byte entry ) {
            return no_entry_value != TByteFloatOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Byte ) {
                    ...
                    if ( ! TByteFloatOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TByteCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteFloatOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( byte[] array ) {
            for ( byte element : array ) {
                if ( ! TByteFloatOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        @Override
        public void clear() {
            TByteFloatOffheapHashMap.this.clear();
        }
        ...
        public boolean forEach( TByteProcedure procedure ) {
            return TByteFloatOffheapHashMap.this.forEachKey( procedure );
        }
    ...
    protected class TValueView implements TFloatCollection {
        ...
        public TFloatIterator iterator() {
            return new TByteFloatValueOffheapHashIterator( TByteFloatOffheapHashMap.this );
        }
        ...
        public boolean contains( float entry ) {
            return TByteFloatOffheapHashMap.this.containsValue( entry );
        }
        ...
        public float[] toArray() {
            return TByteFloatOffheapHashMap.this.values();
        }
        ...
        public float[] toArray( float[] dest ) {
            return TByteFloatOffheapHashMap.this.values( dest );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Float ) {
                    ...
                    if ( ! TByteFloatOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TFloatCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteFloatOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( float[] array ) {
            for ( float element : array ) {
                if ( ! TByteFloatOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean forEach( TFloatProcedure procedure ) {
            return TByteFloatOffheapHashMap.this.forEachValue( procedure );
        }
    ...
    class TByteFloatKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteIterator {
         ...
         */
        TByteFloatKeyOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
        ...
        public void remove() {
            ...
            try {
                ...
                TByteFloatOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TByteFloatValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TFloatIterator {
         ...
         * @param hash the <tt>TPrimitiveOffheapHash</tt> we will be iterating over.
         */
        TByteFloatValueOffheapHashIterator( TPrimitiveOffheapHash hash ) {
            super( hash );
        }
    ...
    class TByteFloatOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteFloatIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TByteFloatOffheapHashMap</tt> we will be iterating over.
         */
        TByteFloatOffheapHashIterator( TByteFloatOffheapHashMap map ) {
            super( map );
        }
