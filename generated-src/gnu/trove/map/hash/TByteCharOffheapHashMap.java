 ...
 */
public class TByteCharOffheapHashMap extends TByteCharOffheapHash implements TByteCharMap, Externalizable {
    ...
    /**
     * Creates a new <code>TByteCharOffheapHashMap</code> instance with the default
    ...
    /**
     * Creates a new <code>TByteCharOffheapHashMap</code> instance with a prime
    ...
    protected class TKeyView implements TByteSet {
        ...
        public boolean remove( byte entry ) {
            return no_entry_value != TByteCharOffheapHashMap.this.remove( entry );
        }
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Byte ) {
                    ...
                    if ( ! TByteCharOffheapHashMap.this.containsKey( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TByteCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteCharOffheapHashMap.this.containsKey( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( byte[] array ) {
            for ( byte element : array ) {
                if ( ! TByteCharOffheapHashMap.this.contains( element ) ) {
                    return false;
                }
            }
            return true;
    ...
    protected class TValueView implements TCharCollection {
        ...
        public boolean containsAll( Collection<?> collection ) {
            for ( Object element : collection ) {
                if ( element instanceof Character ) {
                    ...
                    if ( ! TByteCharOffheapHashMap.this.containsValue( ele ) ) {
                        return false;
                    }
                } else {
                    return false;
        ...
        public boolean containsAll( TCharCollection collection ) {
            ...
            while ( iter.hasNext() ) {
                if ( ! TByteCharOffheapHashMap.this.containsValue( iter.next() ) ) {
                    return false;
                }
            }
            return true;
        ...
        public boolean containsAll( char[] array ) {
            for ( char element : array ) {
                if ( ! TByteCharOffheapHashMap.this.containsValue( element ) ) {
                    return false;
                }
            }
            return true;
    ...
    class TByteCharKeyOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteIterator {
        ...
        public void remove() {
            ...
            try {
                ...
                TByteCharOffheapHashMap.this.removeAt( _index );
            }
            finally {
    ...
    class TByteCharValueOffheapHashIterator extends THashPrimitiveOffheapIterator implements TCharIterator {
    ...
    class TByteCharOffheapHashIterator extends THashPrimitiveOffheapIterator implements TByteCharIterator {

        /**
         * Creates an iterator over the specified map
         *
         * @param map the <tt>TByteCharOffheapHashMap</tt> we will be iterating over.
         */
